...
export default async function ChatPage({ params }: Props) {
  ...
  let sourceWork: { id: string; url: string; caption: string | null; price_cents: number | null; is_poa: boolean; price_currency: string | null } | null = null;
  if (conv.source_work_id) {
    const { data: sw } = await supabase
      .from("artworks")
      .select("id, url, caption, price_cents, is_poa, price_currency")
