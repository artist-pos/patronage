...
const SECTIONS: Section[] = [
  {
    ...
    content: [
      ...
      "Budget honestly. Funders are experienced and will notice if your budget is under-cooked or inflated. Include your own time as a line item (many artists forget this). Show that you understand what the work actually costs.",
  ...
  },
  {
    ...
    content: [
      "Structure your budget in two columns: grant amount requested and total project cost. This shows funders you have other support or are contributing your own resources, which signals commitment.",
  ...
  {
    title: "Key funding bodies in New Zealand",
    content: [
  ...
  {
    title: "Key funding bodies in Australia",
    content: [
