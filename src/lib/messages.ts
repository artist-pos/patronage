...
export async function getMessages(conversationId: string): Promise<Message[]> {
  ...
  const { data } = await supabase
    .from("messages")
    .select("id, conversation_id, sender_id, content, is_read, message_type, work_id, offer_amount, offer_currency, is_system_message, source_action, metadata, created_at")
