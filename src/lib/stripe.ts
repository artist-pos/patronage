...
const DEFAULT_SUCCESS_PATHS: Record<CheckoutPurpose, string> = {
  ...
  campaign_sale:      "/sale/success?session_id={CHECKOUT_SESSION_ID}",
  support_one_off:    "/patrons/success?session_id={CHECKOUT_SESSION_ID}",
  support_recurring:  "/patrons/success?session_id={CHECKOUT_SESSION_ID}",
