...
export const sources: Source[] = [
  ...
  { name: "ArtInfoLand Australia", url: "https://artinfoland.com/location/australia/", country: "AUS", isListPage: true, followLinks: true, maxLinks: 150, pages: 13, paginationUrl: "https://artinfoland.com/location/australia/page/{page}/", isAggregator: true },
  { name: "ArtInfoLand New Zealand", url: "https://artinfoland.com/location/new-zealand/", country: "NZ", isListPage: true, followLinks: true, maxLinks: 30, pages: 3, paginationUrl: "https://artinfoland.com/location/new-zealand/page/{page}/", isAggregator: true },
