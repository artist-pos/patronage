...
Each item in the array:
{
  ...
  "full_description": "Structured plain-text description for the detail page. Use 'Section Name:' headings on their own line (e.g. 'Eligibility:', 'Prize:', 'How to Apply:', 'About the Residency:'). After each heading, write the content as plain paragraphs (double newline between sections). No markdown bold/italic. Max 1500 characters. Null if the source page has no substantive detail beyond the caption.",
